 ...
 */
public class RandomAccessFile extends Reader {
	/**
	 ...
	 * @spec JSR-51
	 */
	public RandomAccessFile(File file, String mode, int bufferSize) throws IOException {
		this.file = new java.io.RandomAccessFile(file, mode);
	 ...
	 * 
	 * @param length
	 *            the maximum number of characters to decode
	...
	public void seek(long pos) throws IOException {
		...
		if (offset == 0)
			return;
		if ((offset > 0 && offset <= charBuffer.remaining()) || (offset < 0 && -offset <= charBuffer.position())) {
