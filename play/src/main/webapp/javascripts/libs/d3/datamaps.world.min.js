    ...
    function addLegend(layer, data, options) {
        ...
        for ( var fillKey in this.options.fills ) {
            ...
            if ( fillKey === 'defaultFill') {
                ...
                // NGA - added ability to define legend
                if (this.options.fillLabels != null) {
                    html += '<dt>' + this.options.fillLabels[index] + ': </dt>';
                } else {
                    html += '<dt>' + fillKey + ': </dt>';
                }
