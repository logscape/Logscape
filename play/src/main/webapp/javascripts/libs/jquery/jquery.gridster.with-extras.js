 ...
 * Neil Issues Fixed
 *  FIXED - :829 - use find() instead of children
 *  this.$widgets = this.$el.find(this.options.widget_selector).addClass('gs_w');
 *
 * OUTSTANDING -
 *   - need to maintain height at all times - and dont shrink it
 *
 *
 *
 */
...
;(function($, window, document, undefined){
    ...
    fn.manage_scroll = function(offset) {
        if (gridster_debug) console.log("Manage_SCROLL:" + offset + " H:" + this.doc_height)
        /* scroll document */
        var nextScrollTop;
    ...
    fn.on_dragstop = function(e) {
        if (gridster_debug) console.log("Drag_STOP")
        var offset = this.get_offset(e);
...
;(function($, window, document, undefined) {
    ...
    function Gridster(el, options) {
        ...
        if (options.min_rows != null) {
            this.$el.css('height', options.min_rows * this.min_widget_height )
        } else {
            this.$el.css('height', 1024)
        }
    ...
    fn.add_widget = function(html, size_x, size_y, col, row) {
        if (gridster_debug) console.log("AddWidget:" + html)
        var pos;
        size_x || (size_x = 1);
        size_y || (size_y = 1);
        ...
        // Dont do this - it seems to kill memory and performance - NGA
    ...
    fn.resize_widget = function($widget, size_x, size_y, callback) {
        if (gridster_debug) console.log("Resize:" + $widget)
    ...
    fn.on_start_drag = function(event, ui) {
        if (gridster_debug) console.log("Start:" + this.$el.height())
...
//            (this.player_grid_data.size_y * this.min_widget_height));
    ...
    fn.set_dom_grid_height = function() {
        if (gridster_debug) console.log("SetDomGridHeight")
