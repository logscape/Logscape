(function() {
    ...
    JUnitXmlReporter.prototype = {
        ...
        reportSpecResults: function(spec) {
            ...
            spec.output = '    <testcase classname="play.' + this.getFullName(spec.suite) +
        ...
        reportSuiteResults: function(suite) {
            ...
            suite.output = '\n<testsuite name="' + this.getFullName(suite) +
                '" id=\"0\" tests="' + specs.length + '" errors="0" failures="' + failedCount + "\" package=\"play.logscape\" hostname=\"unknown\"" +
