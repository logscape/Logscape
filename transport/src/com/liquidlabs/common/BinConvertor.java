...
public class BinConvertor {
	...
	public static int byteArrayToInt(byte[] buffer, int nStartIndex) {
		return 
		(((int) buffer[nStartIndex + 0] & 0x0ff) << 24) | 
	 ...
	 */
	public static byte[] longToByteArray(long lValue, byte[] buffer, int nStartIndex) {
	...
	public static byte[] intToByteArray(int lValue, byte[] buffer, int nStartIndex) {
		buffer[nStartIndex + 0] = (byte) ((lValue >>> 24) & 0x0ff);
