 ...
 */
public class FFCreator implements KvIndexFactory.Creator {
    static public KvIndexFactory.IMPLS INST = KvIndexFactory.IMPLS.FF1;

    private GrokItPool grokitPool = new GrokItPool();

    @Override
    public IndexFeed get() {
        return new FFIndexFeed(KvIndexFactory.env + "/ff", new RulesKeyValueExtractor(), grokitPool);
    }
