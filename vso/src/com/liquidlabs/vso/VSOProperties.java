...
public class VSOProperties {
    ...
    public enum ports { LOOKUP, LOOKUP_REPL, LOOUKP_JMX, SHARED, SHARED_REPL, SHARED_JMX, LOOPBACK, DASHBOARD, AGENT_LOG_SPACE, DASHBOARD_REPL, DASHBOARD_JMX, SAAS, LOGSPACE, LOGSPACE_RPL, LOGSPACE_JMX, AGGSPACE, AGGSPACE_REPL, AGGSPACE_JMX,
