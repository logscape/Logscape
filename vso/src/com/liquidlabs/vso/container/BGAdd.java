...
public class BGAdd implements Action {

	private static final Logger LOGGER = Logger.getLogger(BGAdd.class);
	...
	public BGAdd(String resourceTemplate, Integer resources) {
	...
	protected int requestResources(ResourceSpace resourceSpace, String consumerId, String workIntent, String requestId, String resourceRequest) {
		return resourceSpace.requestBGResources(requestId, resources, priority, resourceRequest, workIntent, VSOProperties.getResourceRequestTimeout(), consumerId, label);
	}
