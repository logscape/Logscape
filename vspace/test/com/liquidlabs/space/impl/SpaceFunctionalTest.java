...
public class SpaceFunctionalTest extends SpaceBaseFunctionalTest {
...
//		assertEquals("A|B|C|1", string[0]);
	...
	public void testSpacesClustersWriteReadData() throws Exception {
		...
		spB.start();
		spA.addPeer(spB.getReplicationURI());
		spB.addPeer(spA.getReplicationURI());
		pause();
		System.out.println(">>>>>>>>>>>>> WRITTTTEE");
