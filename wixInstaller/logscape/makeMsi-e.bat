...
candle -nologo -ext WixUIExtension -ext WixUtilExtension logscape.wxs logscapefiles.wxs -dPlatform=x86
light -nologo -ext WixUIExtension -ext WixUtilExtension -b %WORK%\\%ROOTDIR% logscape.wixobj logscapefiles.wixobj -o %DIST%\Logscape-%VERSION%-setup.msi
del %DIST%\*.wixpdb
echo Done at %time%
